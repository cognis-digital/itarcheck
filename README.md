...
[![PyPI](https://img.shields.io/pypi/v/cognis-itarcheck.svg)](https://pypi.org/project/cognis-itarcheck/)
[![CI](https://github.com/cognis-digital/itarcheck/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/itarcheck/actions)
...
ITARCHECK exists for one job — flags potential itar/ear export-controlled terms and usml categories in code, datasheets, and docs. — and does it without a SaaS bill or heavyweight setup.
...
```bash
itarcheck --version
itarcheck scan .                      # scan the current project
itarcheck scan . --format json
itarcheck scan . --fail-on high       # non-zero exit for CI gates
itarcheck mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **export-control compliance**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`itarcheck` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
