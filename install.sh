#!/usr/bin/env sh
# Universal installer for itarcheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/itarcheck.git"
echo "Installing itarcheck ..."
